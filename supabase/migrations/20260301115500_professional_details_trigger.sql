-- Update the handle_new_user function to include professional details
...
BEGIN
  ...
  -- If role is professional, insert into professionals table with all details
  IF new.raw_user_meta_data->>'role' = 'professional' THEN
      INSERT INTO public.professionals (
          ...
          (new.raw_user_meta_data->'skills')::text[]
      );
  END IF;
