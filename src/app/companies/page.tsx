...
const mockCompanies = [
    {
        ...
        description: 'Sviluppiamo soluzioni AI per frodi finanziarie e analisi del rischio predittiva.',
    ...
    },
    {
        ...
        description: 'Piattaforma di diagnostica avanzata basata su deep learning e computer vision per analizzare radiografie.',
    ...
    },
    {
        ...
        description: 'Ottimizzazione di reti elettriche intelligenti attraverso modelli predittivi.',
        ...
        <div className="container mx-auto px-4 py-12">
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                    Scopri le aziende che stanno plasmando il futuro attraverso l'Intelligenza Artificiale.
                </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {mockCompanies.map((company) => (
                    <div key={company.id} className="glass rounded-3xl p-8 hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {company.tags.map((tag) => (
                                    <span key={tag} className="bg-white/5 border border-white/10 text-xs px-3 py-1 rounded-full text-foreground/80">
                                        {tag}
                                    </span>
                                ))}
                            </div>
